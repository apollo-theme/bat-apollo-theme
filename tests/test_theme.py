...
`Apollo Dark` `Apollo Light.tmTheme`
```text
Apollo Dark
Apollo Light
```
...
"""
        ...
        markers = {
            "dark activation command": "BAT_THEME=Apollo bat path/to/file",
            "light activation command": "BAT_THEME='Apollo Light' bat path/to/file",
        }
        fixture = (
